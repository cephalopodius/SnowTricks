 ...
 */
final class Version20191007121145 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE article (id INT AUTO_INCREMENT NOT NULL, author_id INT NOT NULL, groupe_id INT NOT NULL, title VARCHAR(255) NOT NULL, content TEXT NOT NULL, published_at DATETIME NOT NULL, INDEX IDX_23A0E66F675F31B (author_id), INDEX IDX_23A0E667A45358C (groupe_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE gallery (id INT AUTO_INCREMENT NOT NULL, article_id INT NOT NULL, name VARCHAR(255) NOT NULL, main_picture TINYINT(1) NOT NULL, INDEX IDX_472B783A7294869C (article_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE video ADD CONSTRAINT FK_7CC7DA2C7C29F425 FOREIGN KEY (article_video_id) REFERENCES article (id) ON DELETE CASCADE');
    }
